...
var host = "wplace.live" //Set your domain host without http:// or https:// prefixes and without any subdomain like "www."
var webviewurl = "https://www.wplace.live" //Set your full web app/website URL including http:// or https:// prefix and including subdomains if they are in your URL, like "www.", for example
...
var becomefacebookfriendsurl = "https://www.facebook.com/lerg-lerg/" //Set the URL of your Facebook page
...
static var AdmobBannerID = "ca-app-pub-1718389400322532/7885333993" //Set the AdMob ID for banner ads

static var AdmobinterstitialID = "ca-app-pub-1718389400322532/7924060113" //Set the AdMob ID for interstitial ads
    
static var AdmobRewardedID = "ca-app-pub-1718389400322532/8735381233" //Set the AdMob ID for rewarded ads

static let showBannerAd = true //Set to "true" to activate AdMob banner ads

static let showFullScreenAd = true //Set to "true" to activate AdMob interstitial full-screen ads after X website clicks
...
static let enableRewardedAds = true //Set to "true" to enable AdMob rewarded ads. Required to be "true" even for manual activation of ads.
    
static let useRewardedAdsWherePossible = true //Set to "true" to display admob rewarded ads instead of admob interstitial ads, i.e after x taps etc. Keep as "false" if their activation should be handled via your website's code. Requires showFullScreenAd to also be set to "true" in order to overwrite them.
